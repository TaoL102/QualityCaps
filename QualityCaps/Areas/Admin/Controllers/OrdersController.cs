...
namespace QualityCaps.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        {
            ViewBag.CustomerID = new SelectList(db.Customers, "CustomerID", "FirstMidName");
        ...
        public ActionResult Create([Bind(Include = "OrderID,CustomerID,OrderStatusID,SubTotal,Gst,GrandTotal")] Order order)
        {
